...
<Cards>
  <Card title="ABI Boundary" icon="braces" href="/source/project/abi">
    C-compatible entry points used by Python, C++, and integrations.
  </Card>
  <Card title="CLI Surface" icon="terminal" href="/source/rust-cli/overview">
    Native command-line workflows for scan, control, ID changes, and vendor APIs.
  </Card>
  <Card title="Python Binding" icon="box" href="/source/python/overview">
    ctypes package, Python CLI, examples, and deployment notes.
  </Card>
  <Card title="Integrations" icon="plug" href="/source/integrations/overview">
    ROS2 bridge and WebSocket gateway entry points.
  </Card>
</Cards>
