...
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/motorbridge/motorbridge/blob/main/LICENSE)
[![Platforms](https://img.shields.io/badge/Platforms-Linux%20%7C%20Windows%20%7C%20macOS-6f42c1.svg)](/source/repository/overview#release-and-installation-overview-full-matrix)
...
> Chinese version: [README.zh-CN.md](/zh/source/repository/overview)

## Companion Repos

- `motorbridge-studio`: https://github.com/motorbridge/motorbridge-studio
  Standalone web control UI built on top of `ws_gateway`. Current release: `v1.1.3` (2026-07-23). Split out of `tools/factory_calib_ui_ws`.

<Note>
`motorbridge-studio` evolves independently of this docs site. For its changelog,
capabilities, and release notes, see the studio repository directly.
</Note>
...
- [`motor_core`](https://github.com/motorbridge/motorbridge/tree/main/motor_core): vendor-agnostic controller, routing, CAN bus layer (Linux SocketCAN / Windows experimental PCAN)
- [`motor_vendors/damiao`](https://github.com/motorbridge/motorbridge/tree/main/motor_vendors/damiao): Damiao protocol / models / registers
- [`motor_vendors/hexfellow`](https://github.com/motorbridge/motorbridge/tree/main/motor_vendors/hexfellow): Hexfellow CANopen-over-CAN-FD implementation
- [`motor_vendors/hightorque`](/source/vendors/hightorque/overview): HighTorque native ht_can protocol implementation
- [`motor_vendors/robstride`](https://github.com/motorbridge/motorbridge/tree/main/motor_vendors/robstride): RobStride extended CAN protocol / models / parameters
- [`motor_vendors/myactuator`](https://github.com/motorbridge/motorbridge/tree/main/motor_vendors/myactuator): MyActuator CAN protocol implementation
- [`motor_cli`](/source/rust-cli/overview): unified Rust CLI
  - full parameters (English): [`motor_cli/README.md`](/source/rust-cli/overview)
  - full parameters (Chinese): [`motor_cli/README.zh-CN.md`](/zh/source/rust-cli/overview)
  - Damiao command/register guide: [`motor_cli/DAMIAO_API.md`](/source/rust-cli/damiao-api), [`motor_cli/DAMIAO_API.zh-CN.md`](/zh/source/rust-cli/damiao-api)
  - RobStride command/parameter guide: [`motor_cli/ROBSTRIDE_API.md`](/source/rust-cli/robstride-api), [`motor_cli/ROBSTRIDE_API.zh-CN.md`](/zh/source/rust-cli/robstride-api)
  - MyActuator command/mode guide: [`motor_cli/MYACTUATOR_API.md`](/source/rust-cli/myactuator-api), [`motor_cli/MYACTUATOR_API.zh-CN.md`](/zh/source/rust-cli/myactuator-api)
- [`motor_abi`](https://github.com/motorbridge/motorbridge/tree/main/motor_abi): stable C ABI
- [`bindings/python`](/source/python/overview): Python SDK + `motorbridge-cli`
- [`bindings/cpp`](/source/cpp/overview): C++ RAII wrapper
...
For RobStride, replace `--model rs-06` with the actual motor model (`rs-00` through `rs-06`) for limits/logging. `read-param` / `write-param` uses the common section 4 runtime table.
...
- Or download directly from GitHub:
  - [https://github.com/motorbridge/motorbridge/blob/main/third_party/pcan/macos/macOS_Library_for_PCANUSB_v0.13.tar.gz](https://github.com/motorbridge/motorbridge/blob/main/third_party/pcan/macos/macOS_Library_for_PCANUSB_v0.13.tar.gz)
...
- [`docs/en/can_debugging.md`](/source/project/can-debugging)
- [`docs/zh/can_debugging.md`](/zh/source/project/can-debugging)
...
- [`docs/en/abi.md`](/source/project/abi)
- [`docs/zh/abi.md`](/zh/source/project/abi)
