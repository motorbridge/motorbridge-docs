...
```bash
python3 -m pip install motorbridge==0.5.0
```
...
# 或安装指定预发布版本
python3 -m pip install -i https://test.pypi.org/simple/ motorbridge==0.5.0a1
```
...
```bash
git clone https://github.com/motorbridge/motorbridge
cd motorbridge
