...
| `--dm-device-type` | `usb2canfd-dual` | DM_Device 适配器：usb2canfd, usb2canfd-dual, linkx4c |
| `--dm-channel` | `0` | DM_Device SDK 通道：usb2canfd=0, usb2canfd-dual=0/1, linkx4c=0/1/2/3 |
| `--model` | `4340` | 电机型号字符串 |
