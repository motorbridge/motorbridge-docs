...
| 组件 | 源文件 | 当前版本 |
|------|--------|----------|
| 计划 Git 发布标签 | `motorbridge` 仓库 | `v0.5.0` |
| Python 包 | `bindings/python/pyproject.toml` | `0.5.0` |
| Rust workspace crates | `Cargo.toml` 的 `[workspace.package]` | `0.5.0` |
...
| 0.5.0 | 3.10 | SocketCAN / PCAN / CAN-FD / DM serial / DM-Device | RobStride PP/CSP、dm-device 传输、ABI 元数据、固件版本查询、mode-aware 受控停止 |
...
- [变更日志](https://github.com/motorbridge/motorbridge/releases) - 发布历史
