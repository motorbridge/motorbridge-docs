...
- [`motor_core`](https://github.com/tianrking/motorbridge/tree/main/motor_core): 与厂商无关的控制器、路由、CAN 总线层（Linux SocketCAN / Windows 实验性 PCAN）
- [`motor_vendors/damiao`](https://github.com/tianrking/motorbridge/tree/main/motor_vendors/damiao): Damiao 协议 / 型号 / 寄存器
- [`motor_vendors/hexfellow`](https://github.com/tianrking/motorbridge/tree/main/motor_vendors/hexfellow): Hexfellow CANopen-over-CAN-FD 实现
- [`motor_vendors/hightorque`](/source/vendors/hightorque/overview): HighTorque 原生 ht_can 协议实现
- [`motor_vendors/robstride`](https://github.com/tianrking/motorbridge/tree/main/motor_vendors/robstride): RobStride 扩展 CAN 协议 / 型号 / 参数
- [`motor_vendors/myactuator`](https://github.com/tianrking/motorbridge/tree/main/motor_vendors/myactuator): MyActuator CAN 协议实现
...
- [`motor_abi`](https://github.com/tianrking/motorbridge/tree/main/motor_abi): 稳定 C ABI
