...
<Cards>
  <Card title="ABI 边界" icon="braces" href="/zh/source/project/abi">
    Python、C++ 和集成层共同使用的 C 兼容入口。
  </Card>
  <Card title="CLI 表面" icon="terminal" href="/zh/source/rust-cli/overview">
    原生命令行的扫描、控制、改 ID 和厂商 API 工作流。
  </Card>
  <Card title="Python Binding" icon="box" href="/zh/source/python/overview">
    ctypes 包、Python CLI、示例和部署说明。
  </Card>
  <Card title="集成" icon="plug" href="/zh/source/integrations/ros2-bridge/overview">
    ROS2 bridge 与 WebSocket gateway 入口。
  </Card>
</Cards>
