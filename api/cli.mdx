...
| `--dm-device-type` | — | DM_Device adapter type (for dm-device transport): usb2canfd, usb2canfd-dual, linkx4c |
| `--dm-channel` | — | DM_Device channel. usb2canfd: 0; usb2canfd-dual: 0/1; linkx4c: 0..3. Omit to scan all channels. |
