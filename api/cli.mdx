...
| `--dm-device-type` | `usb2canfd-dual` | DM_Device adapter: usb2canfd, usb2canfd-dual, linkx4c |
| `--dm-channel` | `0` | DM_Device SDK channel: usb2canfd=0, usb2canfd-dual=0/1, linkx4c=0/1/2/3 |
