...
|-----------|-------------|-----------------|
| Planned Git release tag | `motorbridge` repository | `v0.5.0` |
| Python package | `bindings/python/pyproject.toml` | `0.5.0` |
| Rust workspace crates | `Cargo.toml` `[workspace.package]` | `0.5.0` |
...
|----------|---------|-----------|
| Stable | `0.5.0` | Production ready |
| Pre-release | `0.5.0a1` | Testing only |
| Development | `0.5.0.dev1` | Internal use |
...
pip install -i https://test.pypi.org/simple/ motorbridge==0.5.0a1
```
...
```bash
# Install from Git
pip install git+https://github.com/motorbridge/motorbridge@v0.5.0

# Install specific branch
pip install git+https://github.com/motorbridge/motorbridge@main
```
...
# Upgrade to latest stable: 0.5.0
pip install --upgrade motorbridge
...
pip install -i https://test.pypi.org/simple/ motorbridge==0.5.0b1
...
6. **Verify installation:**
   ```bash
   pip install -i https://test.pypi.org/simple/ motorbridge==0.5.0
   python3 -m pytest tests/
   ```
...
twine upload dist/motorbridge-0.5.0.tar.gz
...
- [Changelog](https://github.com/motorbridge/motorbridge/releases) - Release history
