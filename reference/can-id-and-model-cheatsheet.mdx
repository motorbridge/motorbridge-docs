...
RobStride uses one upper-level command shape across RS models. Parameter read/write in MotorBridge v0.4.1 uses the common protocol section 4 runtime table (`0x7005..0x702E`).
